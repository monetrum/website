...
function highlight_get_footer_copyright($copyright, $preview_atts)
{
    ...
    $copyright = "<small style='font-size:12px;opacity:.6'>Monetrum Platformu 7061 sayılı kanun ve buna bağlı mevzuatlarına tabi olan “kitlesel fonlama” vasfında veya bu iddiada bulunan bir platform değildir.</small>";
